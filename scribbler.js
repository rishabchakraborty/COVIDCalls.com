...
if (document.getElementsByClassName('demo').length > 0) {
  ...
  var txt = `Universal Derivatives
            ...
            Synthetic Asset: The combination of securities and/or assets in such a way that they produce the same financial effect as the ownership of an entirely different asset would.

            - Free from physical barriers
            - More accessible to different people
            - COVID-Calls helps incentive COVID Protocol in high risk regions
